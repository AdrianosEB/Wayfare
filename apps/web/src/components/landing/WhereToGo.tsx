...
export function WhereToGo() {
  return (
    <Section glow>
      ...
      <RevealGroup className="no-scrollbar mt-8 -mx-6 flex snap-x-mandatory gap-4 overflow-x-auto px-6 pb-2 sm:mx-0 sm:grid sm:grid-cols-2 sm:overflow-visible sm:px-0 lg:grid-cols-4">
